...
| **Source code (GitHub)** | [github.com/misri12/odoo_shopify_connector_pro](https://github.com/misri12/odoo_shopify_connector_pro) — clone, fork, or install from source (see [Install from GitHub](#42-install-from-github) below). |
...
1. Copy the module into your Odoo addons path:
   ...
   - Example:  
     `odoo-19.0/custom_addons/odoo_shopify_connector_pro`
...
1. Clone the repository into your Odoo addons path:
   ...
   git clone https://github.com/gultajkhan/odoo_shopify_connector_pro.git
   ```
